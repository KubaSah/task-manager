"""Add failed login tracking columns to users

Revision ID: c966f8ce2d73
Revises: b1a2c3d4e5f6
Create Date: 2025-11-16 14:32:40.815503
...
def upgrade():
    ...
    with op.batch_alter_table('user_identities', schema=None) as batch_op:
        batch_op.create_index('ix_identity_user_provider', ['user_id', 'provider'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('user_identities', schema=None) as batch_op:
        batch_op.drop_index('ix_identity_user_provider')
